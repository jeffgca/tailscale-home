...
<main>
	<header>
		<div class="header-content">
			...
			<button type="button" class="btn-link-main" onclick={openMainPage}>
				Open Main Page →
			</button>
		</div>
	</header>
	...
	<div class="settings-form">
		...
		<div class="form-group">
			...
			<p class="help-text">
				Use "-" for your default tailnet, or enter your specific tailnet ID
			</p>
		</div>
		...
		<div class="form-group">
			<label for="tailnetCheckInterval">
				Tailnet Connection Check Interval (seconds)
			</label>
			<input
				id="tailnetCheckInterval"
				type="number"
				bind:value={tailnetCheckInterval}
				min="5"
				max="300"
			/>
			<p class="help-text">
				How often to check if this device is connected to the tailnet (default:
				30 seconds)
			</p>
		</div>

		<div class="form-group">
			<label for="deviceProbeInterval">
				Device Reachability Probe Interval (seconds)
			</label>
			<input
				id="deviceProbeInterval"
				type="number"
				bind:value={deviceProbeInterval}
				min="30"
				max="3600"
			/>
			<p class="help-text">
				How often to probe device reachability when connected to tailnet
		...
		<div class="button-group">
			...
			<button type="button" class="btn btn-outline" onclick={handleClear}>
				Clear
			</button>
		</div>
	</div>
	...
	<footer>
		<div class="info-box">
			...
			<ul>
				...
				<li>
					You can create keys in the <a
						href="https://login.tailscale.com/admin/settings/keys"
						target="_blank"
						rel="noopener noreferrer">Tailscale Admin Console</a
					>
				</li>
